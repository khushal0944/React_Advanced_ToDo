                ...
                <div id="todoMainBox" className='overflow-auto rounded-xl px-1  dark:bg-[#212121] bg-[#d4d4d4] w-5/6 shadow-2xl'>
                    ...
                    <div className="flex justify-center gap-x-4 items-center text-white mt-5 ">
                        <div id="inputBox" className='bg-white border-2 dark:bg-slate-600 border-black rounded h-8 relative w-3/5'>
                            ...
                            <input type="search" name="search" onInput={(e) => setSearch(e.target.value)} className='dark:placeholder:text-white dark:bg-slate-600 dark:text-white text-black w-full h-full outline-none pl-8 rounded ' placeholder='Search ToDo...' />
                        </div>
                        <div id="selectBox" >
                        ...
                        <button className='dark:bg-purple-800 bg-blue-500 hover:bg-blue-700 w-9 max-sm:w-10 rounded-full h-9 dark:hover:bg-purple-900' onClick={()=> dispatch(toggleTheme())}>{theme === "dark" ? <i className="ri-sun-fill "></i> : <i className="ri-moon-fill"></i>}</button>
                    </div>                    
                    <h1 className='text-center dark:text-white uppercase mt-5 text-3xl font-medium'>tasks : {tasks}</h1>
